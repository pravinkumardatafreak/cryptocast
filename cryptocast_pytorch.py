...
==================================================================================
Parallel entry point running the complete end-to-end pipeline:
  Step 1: Data loading, cleaning, EDA, and preprocessing (TensorFlow-independent)
  Step 2: Train all 12 models in PyTorch (1D-CNN, RNN, LSTM, Transformer for 1D, 3D, 7D horizons)
  Step 3: Generate comparison visualizations from the PyTorch metrics

Usage:
    python cryptocast_pytorch.py
"""
